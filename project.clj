(defproject netronixgroup "0.1.0-SNAPSHOT"
  ...
  {:builds
   [{:id           "dev"
     ...
     :figwheel     {:on-jsload "netronixgroup.core/mount-root"}
     :compiler     {:main                 netronixgroup.core
    ...
    {:id           "test"
     ...
     :compiler     {:main          netronixgroup.runner
